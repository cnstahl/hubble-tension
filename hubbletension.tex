...
\end{align}
where $\rho_b$ is the baryon density and $\rho_\gamma$ is the density of photons. In analogy with Eqn.~\ref{eqn:comoving} we can define the comoving sound horizon~\cite{Planck2013}
\begin{align}
